...
app = web.Application([
    ...
    (r'/(logo.png)', web.StaticFileHandler, {'path': './'}),
    (r'/control.html', ControlHandler),
    (r'/control', ControlHandler),
    (r'/(control.css)', web.StaticFileHandler, {'path': './'}),
    (r'/(control.js)', web.StaticFileHandler, {'path': './'}),
    (r'/(jquery.js)', web.StaticFileHandler, {'path': './'}),
    (r'/(PoliticsHead.otf)', web.StaticFileHandler, {'path': './'}),
])
